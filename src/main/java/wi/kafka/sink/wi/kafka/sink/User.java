...
public class User extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9198068064077102307L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"User\",\"namespace\":\"wi.kafka.sink\",\"fields\":[{\"name\":\"first_name\",\"type\":\"string\",\"doc\":\"First Name of User\"},{\"name\":\"last_name\",\"type\":\"string\",\"doc\":\"Last Name of User\"}],\"version\":\"1\"}");
   ...
   */
  public static wi.kafka.sink.User.Builder newBuilder() {
    return new wi.kafka.sink.User.Builder();
  }
   ...
   * @return A new User RecordBuilder
   */
  public static wi.kafka.sink.User.Builder newBuilder(wi.kafka.sink.User.Builder other) {
    if (other == null) {
      return new wi.kafka.sink.User.Builder();
    } else {
      return new wi.kafka.sink.User.Builder(other);
    }
  }
   ...
   * @return A new User RecordBuilder
   */
  public static wi.kafka.sink.User.Builder newBuilder(wi.kafka.sink.User other) {
    if (other == null) {
      return new wi.kafka.sink.User.Builder();
    } else {
      return new wi.kafka.sink.User.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<User>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(wi.kafka.sink.User.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(wi.kafka.sink.User other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.first_name)) {
        this.first_name = data().deepCopy(fields()[0].schema(), other.first_name);
    ...
    /**
      ...
      * @return This builder.
      */
    public wi.kafka.sink.User.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public wi.kafka.sink.User.Builder clearFirstName() {
      first_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public wi.kafka.sink.User.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public wi.kafka.sink.User.Builder clearLastName() {
      last_name = null;
